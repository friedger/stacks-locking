...
function isValidNetValue(
  maybeNetwork: unknown
): maybeNetwork is "testnet" | "mainnet" {
...
export const STACKING_LEARN_MORE_URL =
  "https://stacks.org/stacking-moves-us-forward";
...
export const UI_IMPOSED_MAX_STACKING_AMOUNT_USTX =
  stxToMicroStx(10_000_000_000);
...
export const SEND_MANY_CONTACT_ID =
  "SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE.send-many-memo";

export const BUY_STACKS_URL =
  "https://coinmarketcap.com/currencies/stacks/markets/";
