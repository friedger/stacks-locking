...
describe(toHumanReadableStx.name, () => {
  test("it presents numbers correctly according to en-US locale", () => {
    ...
    expect(toHumanReadableStx("111111111111111")).toEqual(
      "111,111,111.111111 STX"
    );
    expect(toHumanReadableStx("9999999999999998")).toEqual(
      "9,999,999,999.999998 STX"
    );
    expect(toHumanReadableStx("9999999999999999")).toEqual(
      "9,999,999,999.999999 STX"
    );
    expect(toHumanReadableStx("999999999999999999998")).toEqual(
